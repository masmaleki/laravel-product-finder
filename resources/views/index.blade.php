                    ...
                    <fieldset>
                        ...
                        <div class="fieldset-content">
                            ...
                            <div class="form-group">
                                <h4>What is your technilogy you pereferd?</h4>

                                <label class="checkbox">
                                    <input class="cehckbox" type="checkbox" name="html" value="HTML"><span>HTML</span>
                                  </label>
                                  
                                  <label class="checkbox">
                                    <input type="checkbox" name="css" value="CSS"><span>CSS</span>
                                  </label>
